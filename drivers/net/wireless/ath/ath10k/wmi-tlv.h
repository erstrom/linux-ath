...
enum wmi_tlv_tag {
	...
	WMI_TLV_TAG_STRUCT_OCB_SET_SCHED_CMD, /* DEPRECATED */
	WMI_TLV_TAG_STRUCT_OCB_SET_SCHED_EVENT, /* DEPRECATED */
	...
	WMI_TLV_TAG_STRUCT_ROAM_FILTER,
	...
	WMI_TLV_TAG_STRUCT_PEER_SET_RATE_REPORT_COND,
